...
#define MAX_TIME_MUX 2
#define CONN_MATRIX_MAX MAX_N_SIZE*MAX_N_SIZE
#define CONN_MATRIX_HW  CONN_MATRIX_MAX/8
#define IAPP_MAX_CHARS 8 //2 integer, the dot, 3 decimals and the delimiter
...
void ComputeOneCellTimeMux1(int,  mod_prec*,mod_prec* , int, int, mod_prec*);
void ComputeOneCellTimeMux2(int,  mod_prec*,mod_prec* , int, int, mod_prec*);
void ComputeOneCellTimeMux3(int,  mod_prec*,mod_prec* , int, int, mod_prec*);
void ComputeOneCellTimeMux4(int,  mod_prec*,mod_prec* , int, int, mod_prec*);
void ComputeOneCellTimeMux5(int,  mod_prec*,mod_prec* , int, int, mod_prec*);
void ComputeOneCellTimeMux6(int,  mod_prec*,mod_prec* , int, int, mod_prec*);
void ComputeOneCellTimeMux7(int,  mod_prec*,mod_prec* , int, int, mod_prec*);
void ComputeOneCellTimeMux8(int,  mod_prec*,mod_prec* , int, int, mod_prec*);

//void ComputeOneCell( int,int, mod_prec, mod_prec* );
void ComputeOneCell0( int,int, mod_prec ,mod_prec*, int, mod_prec*);
void ComputeOneCell1( int,int, mod_prec ,mod_prec*, int, mod_prec*);
void ComputeOneCell2( int,int, mod_prec ,mod_prec*, int, mod_prec*);
void ComputeOneCell3( int,int, mod_prec ,mod_prec*, int, mod_prec*);
void ComputeOneCell4( int,int, mod_prec ,mod_prec*, int, mod_prec*);
void ComputeOneCell5( int,int, mod_prec ,mod_prec*, int, mod_prec*);
void ComputeOneCell6( int,int, mod_prec ,mod_prec*, int, mod_prec*);
void ComputeOneCell7( int,int, mod_prec ,mod_prec*, int, mod_prec*);
