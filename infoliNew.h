...
#define FIVE_EIGHT -0.1724137931f	//		-1/5.8f
#define THIRTY_THREE 0.0303030303f	//		1/33.0f
#define TEN 0.1f
#define TWELVE -0.08333333333f		//		-1/12.0f
#define NINE_HUNDRED 0.00111111111f	//		1/900.0f
